                        ...
                        Column(
                            ...
                            Column(
                                ...
                                val qrWidthFraction = if (item.type == ItemType.BOTH) {
                                    BOTH_QR_WIDTH_FRACTION
                                } else {
                                    QR_ONLY_WIDTH_FRACTION
                                }
                                val bitmap = qrBitmap
                                if (bitmap != null) {
                                    Image(
...
/** Matches [com.sharemyththing.tile.TileLayoutBuilder] BOTH tile QR size. */
private const val BOTH_QR_WIDTH_FRACTION = 0.52f
private const val QR_ONLY_WIDTH_FRACTION = 0.72f
